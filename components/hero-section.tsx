...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex min-h-[580px] max-w-7xl flex-col items-center justify-center overflow-hidden rounded-[2.5rem] border border-stone-200/80 bg-white p-8 shadow-2xl md:min-h-[640px] md:p-16 text-center">
        ...
        <div className="relative z-10 mx-auto flex max-w-3xl flex-col items-center">
          {/* Player Trust Badge */}
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-stone-300/80 bg-white/90 px-4 py-1.5 shadow-sm backdrop-blur-md">
          ...
          {/* Subtitle */}
          <p className="mt-5 max-w-xl text-balance text-sm font-medium leading-relaxed text-stone-700 sm:text-base md:text-lg">
